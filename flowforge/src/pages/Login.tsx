    ...
    <div className="flex min-h-screen flex-col justify-between bg-[#f5f6fa] text-[#1a1b22] dark:bg-[#0b0d12] dark:text-[#f1f0fa]">
        ...
        <div className="w-full max-w-[440px] rounded-xl border border-[#e4e6eb] bg-white p-8 shadow-sm dark:border-[#2a2c38] dark:bg-[#15171f]">
          ...
          <div className="grid grid-cols-2 gap-3">
            <a
              ...
              className="flex items-center justify-center gap-2 rounded-lg border border-[#e4e6eb] bg-white py-2 text-sm font-medium text-[#1a1b22] hover:bg-gray-50 dark:border-[#2a2c38] dark:bg-[#15171f] dark:text-white dark:hover:bg-[#1e202b]"
            >
              <svg className="h-4 w-4" viewBox="0 0 24 24">
                <path
                  fill="#EA4335"
                  d="M12.24 10.285V14.4h6.887c-.275 1.565-1.88 4.604-6.887 4.604-4.33 0-7.866-3.577-7.866-8s3.536-8 7.866-8c2.46 0 4.105 1.025 5.047 1.926l3.245-3.125C18.465 1.921 15.56 1 12.24 1 5.92 1 1 5.92 1 12.24s4.92 11.24 11.24 11.24c6.6 0 11-4.606 11-11.24 0-.756-.08-1.334-.18-1.955H12.24z"
                />
              </svg>
              Google
            </a>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label
                htmlFor="email"
                className="mb-1.5 block text-xs font-semibold text-[#1a1b22] dark:text-[#f1f0fa]"
              >
                Email Address
              </label>
              <input
            ...
            <div>
              <div className="mb-1.5 flex items-center justify-between">
                <label
                  htmlFor="password"
                  className="block text-xs font-semibold text-[#1a1b22] dark:text-[#f1f0fa]"
                >
                  Password
                </label>
              </div>
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full rounded-lg border border-[#e4e6eb] bg-white px-3.5 py-2 pr-10 text-sm text-[#1a1b22] placeholder-[#757684] outline-none transition-colors focus:border-[#00288e] dark:border-[#2a2c38] dark:bg-[#15171f] dark:text-white dark:placeholder-[#5a5c68] dark:focus:border-[#b8c4ff]"
                  required
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between py-1 text-xs">
              <label className="flex items-center gap-2 font-medium text-[#757684] dark:text-[#a8aab8]">
                <input
                  type="checkbox"
                  checked={rememberMe}
                  onChange={(e) => setRememberMe(e.target.checked)}
                  className="h-4 w-4 rounded border-[#e4e6eb] text-[#00288e] outline-none dark:border-[#2a2c38]"
                />
              ...
              <a
                ...
                className="font-semibold text-[#00288e] hover:underline dark:text-[#b8c4ff]"
              >
                Forgot password?
              </a>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-2 w-full rounded-lg bg-[#00288e] py-2.5 text-sm font-semibold text-white transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60 dark:bg-[#3b52d9]"
            >
      ...
      <footer className="flex flex-col items-center justify-between gap-2 border-t border-[#e4e6eb] px-8 py-6 text-xs text-[#757684] sm:flex-row dark:border-[#2a2c38] dark:text-[#a8aab8]">
        <div className="flex gap-4">
          ...
          <a href="#help" onClick={(e) => e.preventDefault()} className="hover:underline">Help Center</a>
        </div>
        <p>© 2024 FlowForge Inc. All rights reserved.</p>
      </footer>
    </div>
  );
}
